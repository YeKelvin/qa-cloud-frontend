...
export const queryHttpheaderTemplateList = (params) =>
  request.get('/script/httpheader/template/list', { params: params })

export const queryHttpheaderTemplateAll = (params) => request.get('/script/httpheader/template/all', { params: params })

export const queryHttpheaderTemplateAllInPrivate = (params) =>
  request.get('/script/httpheader/template/all/in/private', { params: params })
...
export const deleteHttpheaderTemplate = (data) => request.delete('/script/httpheader/template', { data: data })
...
export const queryHttpHeaders = (params) =>
  request.get('/script/http/headers', { params: params, paramsSerializer: { indexes: null } })
