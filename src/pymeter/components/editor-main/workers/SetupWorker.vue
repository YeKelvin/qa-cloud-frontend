<template>
  <div class="pymeter-component-container" tabindex="-1">
    ...
    >
      ...
      <!-- 元素属性 -->
      <el-form-item label="失败时的处理：" prop="property.SetupWorker__on_sample_error">
        <el-select
...
const elementFormRules = reactive({
  ...
  'property.SetupWorker__on_sample_error': [{ required: true, message: '失败时的处理不能为空', trigger: 'blur' }],
