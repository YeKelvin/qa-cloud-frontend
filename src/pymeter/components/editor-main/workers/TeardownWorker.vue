<template>
  <div class="pymeter-component-container" tabindex="-1">
    ...
    >
      ...
      <el-form-item label="并发数：" prop="property.TearDownWorker__number_of_threads">
        <el-input v-model="elementInfo.property.TearDownWorker__number_of_threads" clearable disabled />
      </el-form-item>
      <el-form-item label="循环次数：" prop="property.TearDownWorker__main_controller.property.LoopController__loops">
        <el-input
          v-model="elementInfo.property.TearDownWorker__main_controller.property.LoopController__loops"
          clearable
          disabled
        />
      </el-form-item>
